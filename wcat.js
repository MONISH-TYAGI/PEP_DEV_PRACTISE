...
filesArr.push(inputArr[i]);
 ...
 for(let i=0;i<filesArr.length;i++)
 {
  ...
  {   console.log(`file ${filesArr[i]} is not exist `)
    ...
    // wcat filepath1 filepath2 filepath3 path display content of file
 let content=""; 
 for(let i=0;i<filesArr.length;i++)
 {
...
// wcat filepath1 > filepath2 =>puts all content of file1 to file2(overriding) if exist and if not then create it and then copied the content in it
// wcat filepath1>> filepath2 =>append all content of file1 to file2
